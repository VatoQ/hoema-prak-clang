...
from ._core import (
    ensure_signatures, CMatrix, CVector, DataType, MatrixStatus, NormType,
    _get_element_size, _python_to_c_array, _c_array_to_python,
    _get_scalar_value, _check_matrix_status, _check_vector_status,
    DimensionError, MathError, BasicError
)
...
class Matrix:
    ...
    def __init__(self, m: int, n: int, data_type: int = DataType.REAL, 
    ...
    @classmethod
    def zeros(cls, m: int, n: int, 
              data_type: int = DataType.REAL) -> Matrix:
    ...
    @classmethod
    def random_normal(cls, m: int, n: int, mean: float = 0.0,
                      variance: float = 1.0,
                      data_type: int = DataType.REAL) -> Matrix:
    ...
    @classmethod
    def random_uniform(cls, m: int, n: int, min_val: float = 0.0,
                       max_val: float = 1.0,
                       data_type: int = DataType.REAL) -> Matrix:
    ...
    def copy(self) -> Matrix:
        ...
        lib.Matrix_copy(POINTER(CMatrix)(target._c_matrix), 
    ...
    def get_at(self, i: int, j: int) -> Any:
        ...
        status = lib.Matrix_get_at(ctypes.cast(buffer, ctypes.c_void_p),
                                   POINTER(CMatrix)(self._c_matrix), i, j)
    ...
    def add(self, other: Matrix) -> Matrix:
        ...
        lib = ensure_signatures()
        result = self.copy()
        status = lib.Matrix_add(POINTER(CMatrix)(result._c_matrix),
    ...
    def sub(self, other: Matrix) -> Matrix:
        ...
        lib = ensure_signatures()
        result = self.copy()
        status = lib.Matrix_sub(POINTER(CMatrix)(result._c_matrix),
                                POINTER(CMatrix)(other._c_matrix))
        _check_matrix_status(status)
        return result
    ...
    def scale(self, scalar: Union[float, complex]) -> Matrix:
        ...
        lib = ensure_signatures()
        result = self.copy()
        lib.Matrix_scale(POINTER(CMatrix)(result._c_matrix), 
                        ctypes.c_double_complex(scalar))
        return result
    ...
    def matmul(self, other: Union[Matrix, Vector]) -> Union[Matrix, Vector]:
        ...
        if isinstance(other, Matrix):
            ...
            status = lib.Matrix_Matrix_dot(POINTER(CMatrix)(result._c_matrix),
                                          POINTER(CMatrix)(self._c_matrix),
                                          POINTER(CMatrix)(other._c_matrix))
            _check_matrix_status(status)
            return result
            ...
            status = lib.Matrix_Vector_dot(POINTER(CVector)(result._c_vector),
                                          POINTER(CMatrix)(self._c_matrix),
    ...
    def inverse(self) -> Matrix:
        ...
        status = lib.Matrix_inverse(POINTER(CMatrix)(result._c_matrix),
                                    POINTER(CMatrix)(self._c_matrix))
        _check_matrix_status(status)
        return result
    ...
    def solve(self, rhs: Union[Vector, Matrix]) -> Union[Vector, Matrix]:
        ...
        if isinstance(rhs, Vector):
            ...
            status = lib.Matrix_Vector_solve(POINTER(CVector)(result._c_vector),
                                            POINTER(CMatrix)(self._c_matrix),
            ...
            status = lib.Matrix_Matrix_solve(POINTER(CMatrix)(result._c_matrix),
                                            POINTER(CMatrix)(self._c_matrix),
    ...
    def qr(self) -> tuple[Matrix, Matrix]:
        ...
        status = lib.Matrix_QR(POINTER(CMatrix)(Q._c_matrix),
    ...
    def eigenvalues(self, sort: bool = False) -> Vector:
        ...
        status = lib.Matrix_eigvals(POINTER(CVector)(evals._c_vector),
                                    POINTER(CMatrix)(self._c_matrix),
                                    sort)
        _check_matrix_status(status)
        return evals
    ...
    def norm(self, norm_type: int = NormType.FROBENIUS) -> float:
        ...
        lib.Matrix_norm(ctypes.byref(result), POINTER(CMatrix)(self._c_matrix),
                       norm_type)
        return result.value
    ...
    def max(self) -> Union[float, complex]:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        lib.Matrix_max(ctypes.cast(buffer, ctypes.c_void_p),
                      POINTER(CMatrix)(self._c_matrix))
        return _get_scalar_value(ctypes.cast(buffer, ctypes.c_void_p), 
                                self.data_type)
    ...
    def min(self) -> Union[float, complex]:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        lib.Matrix_min(ctypes.cast(buffer, ctypes.c_void_p),
                      POINTER(CMatrix)(self._c_matrix))
        return _get_scalar_value(ctypes.cast(buffer, ctypes.c_void_p),
                                self.data_type)
...
class Vector:
    ...
    def __init__(self, dim: int, data_type: int = DataType.REAL,
                 init_values: Optional[Iterable] = None):
        """
        Initialize a Vector.
    ...
    @classmethod
    def random_normal(cls, dim: int, mean: float = 0.0,
                      variance: float = 1.0,
                      data_type: int = DataType.REAL) -> Vector:
    ...
    @classmethod
    def random_uniform(cls, dim: int, min_val: float = 0.0,
                       max_val: float = 1.0,
                       data_type: int = DataType.REAL) -> Vector:
    ...
    def copy(self) -> Vector:
        ...
        lib.Vector_copy(POINTER(CVector)(result._c_vector),
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        status = lib.Vector_at(ctypes.cast(buffer, ctypes.c_void_p),
                              POINTER(CVector)(self._c_vector), index)
    ...
    def add(self, other: Vector) -> Vector:
        ...
        lib = ensure_signatures()
        result = self.copy()
        status = lib.Vector_add(POINTER(CVector)(result._c_vector),
                               POINTER(CVector)(other._c_vector))
        _check_vector_status(status)
        return result
    ...
    def sub(self, other: Vector) -> Vector:
        ...
        lib = ensure_signatures()
        result = self.copy()
        status = lib.Vector_sub(POINTER(CVector)(result._c_vector),
                               POINTER(CVector)(other._c_vector))
        _check_vector_status(status)
        return result
    ...
    def dot(self, other: Vector) -> Union[float, complex]:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        status = lib.Vector_dot(ctypes.cast(buffer, ctypes.c_void_p),
                               POINTER(CVector)(self._c_vector),
                               POINTER(CVector)(other._c_vector))
        _check_vector_status(status)
        return _get_scalar_value(ctypes.cast(buffer, ctypes.c_void_p),
    ...
    def max(self) -> Union[int, float, complex]:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        lib.Vector_max(ctypes.cast(buffer, ctypes.c_void_p),
                      POINTER(CVector)(self._c_vector))
        return _get_scalar_value(ctypes.cast(buffer, ctypes.c_void_p),
                                self.data_type)
    ...
    def min(self) -> Union[int, float, complex]:
        ...
        element_size = _get_element_size(self.data_type)
        buffer = ctypes.create_string_buffer(element_size)
        lib.Vector_min(ctypes.cast(buffer, ctypes.c_void_p),
                      POINTER(CVector)(self._c_vector))
        return _get_scalar_value(ctypes.cast(buffer, ctypes.c_void_p),
                                self.data_type)
    ...
    def sort(self) -> Vector:
        ...
        lib = ensure_signatures()
        result = Vector(self.dim, self.data_type)
        status = lib.Vector_sort(POINTER(CVector)(result._c_vector),
                                POINTER(CVector)(self._c_vector))
        _check_vector_status(status)
        return result
