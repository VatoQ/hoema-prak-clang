...
def _find_library() -> str:
    ...
    search_paths = [
        os.path.join(repo_root, "python", "fluxioncore", "libfluxioncore.so"),
...
def _setup_function_signatures(lib: ctypes.CDLL) -> None:
    ...
    lib.Matrix_new_random_normal.argtypes = [
        c_size_t,
        c_size_t,
        c_double,
        c_double,
    ...
    lib.Matrix_new_random_uniform.argtypes = [
        c_size_t,
        c_size_t,
        c_double,
        c_double,
    ...
    lib.Matrix_Matrix_dot.argtypes = [
        POINTER(CMatrix),
        POINTER(CMatrix),
        POINTER(CMatrix),
    ]
    ...
    lib.Matrix_Vector_dot.argtypes = [
        POINTER(CVector),
        POINTER(CMatrix),
        POINTER(CVector),
    ]
    ...
    lib.Matrix_Vector_solve.argtypes = [
        POINTER(CVector),
        POINTER(CMatrix),
        POINTER(CVector),
    ]
    ...
    # lib.Matrix_Matrix_solve.argtypes = [
    #     POINTER(CMatrix),
    #     POINTER(CMatrix),
    #     POINTER(CMatrix),
    # ]
    ...
    lib.Matrix_Vector_outer.argtypes = [
        POINTER(CMatrix),
        POINTER(CVector),
        POINTER(CVector),
    ]
    ...
    lib.Matrix_Hadamard_dot.argtypes = [
        POINTER(CMatrix),
        POINTER(CMatrix),
        POINTER(CMatrix),
    ]
    ...
    lib.fourier_transform.argtypes = [
        POINTER(CDataPoints),
        POINTER(CDataPoints),
        c_bool,
    ]
...
def _c_array_to_python(
    ptr: c_void_p, size: int, dt: int
